...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-km42swu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-km42swu.containers.anotherwebservice.com/
...
```
git clone git@github.com:shadab0/container-km42swu.git
cd container-km42swu
```
...
```
docker attach container-km42swu
```
